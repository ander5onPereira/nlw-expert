...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handlerSaveNote(event: FormEvent) {
    ...
    setContent("");
    setShouldShowOnboarding(true);
    toast.success("Noda criada com sucesso");
  }
    ...
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md bg-slate-700 p-5 flex flex-col gap-3 text-left hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
        ...
        <p className="text-sm leading-6 text-slate-400">
          Greve uma nota em áudio que será convertido para texto
          automaticamente.
        </p>
      </Dialog.Trigger>
      <Dialog.Portal>
